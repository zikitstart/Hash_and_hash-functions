...
public class Main {
    public static void main(String[] args) {
        ...
        Mechanic<Bus> mechanic3 = new Mechanic<>("Илья Волков", "СТО 1");
        ...
        car1.addDriver(driverB,driverB);
        car1.addMechanic(mechanic1,mechanic1);
        car1.addSponsor(sponsor1, sponsor2,sponsor1);
